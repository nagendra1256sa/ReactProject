    ...
    <div className='w-full bg-white py-16  px-4'>
        ...
        <div className='w-[1520px] mx-auto grid md:grid-cols-2'>
           ...
           <div className='flex flex-col justify-center'>
            ...
            <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>Limitless conveniece on-demand</h1>
            <p>
            ...
            <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my6 mx-auto md:mx-0 py-3'>Get Started</button>
           </div>
        </div>
    </div>
   )
